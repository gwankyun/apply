...
#  endif // !APPLY_STD_GET
    ...
    inline auto apply(F&& f, std::tuple<T0>&& tuple_) -> typename boost::result_of<F(T0)>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(2, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(2, BOOST_PP_TYPE, T))>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(3, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(3, BOOST_PP_TYPE, T))>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(4, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(4, BOOST_PP_TYPE, T))>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(5, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(5, BOOST_PP_TYPE, T))>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(6, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(6, BOOST_PP_TYPE, T))>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(7, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(7, BOOST_PP_TYPE, T))>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(8, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(8, BOOST_PP_TYPE, T))>::type
    {
    ...
    inline auto apply(F&& f, std::tuple<BOOST_PP_REPEAT(9, BOOST_PP_TYPE, T)>&& tuple_)
        -> typename boost::result_of<F(BOOST_PP_REPEAT(9, BOOST_PP_TYPE, T))>::type
    {
